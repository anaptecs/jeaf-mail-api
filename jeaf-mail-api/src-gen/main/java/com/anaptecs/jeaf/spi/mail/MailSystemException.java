 ...
 * @see SystemException
 */
public final class MailSystemException extends SystemException {
  /**
   ...
   */
  public MailSystemException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public MailSystemException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public MailSystemException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * @param pCause Throwable object that caused this exception. The parameter may be null.
   */
  public MailSystemException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public MailSystemException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
