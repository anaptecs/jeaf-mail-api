 ...
 */
public final class MailApplicationException extends ApplicationException {
  /**
   ...
   */
  public MailApplicationException( ErrorCode pErrorCode ) {
    super(pErrorCode);
  }
   ...
   * null.
   */
  public MailApplicationException( ErrorCode pErrorCode, String... pMessageParameters ) {
   ...
   */
  public MailApplicationException( ErrorCode pErrorCode, Throwable pCause ) {
   ...
   * null.
   */
  public MailApplicationException( ErrorCode pErrorCode, Throwable pCause, String... pMessageParameters ) {
   ...
   * null.
   */
  public MailApplicationException( ErrorCode pErrorCode, String pTechnicalDetails, Throwable pCause,
